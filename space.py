...
def train_agent(env_name, episodes=1000, render=False):
    ...
    for e in range(1, episodes+1):
        ...
        # Inside train_agent()
        if e % 100 == 0:
            agent.save(f"{save_dir}/spaceinvaders_dqn_ep{e}.pt")
            plot_training_results(e, scores, average_scores, epsilon_values, game="spaceinvaders")

# Final save
    agent.save(f"{save_dir}/spaceinvaders_dqn_final.pt")
    plot_training_results(episodes, scores, average_scores, epsilon_values, game="spaceinvaders")

    env.close()
    return agent, scores, average_scores

def plot_training_results(episodes, scores, avg_scores, epsilons, game="spaceinvaders"):
    ...
    plt.tight_layout()
    plt.savefig(f"{save_dir}/{game}_training_results_ep{episodes}.png")
    plt.close()
...
if __name__ == "__main__":
    ...
    model_path = f"{save_dir}/spaceinvaders_dqn_final.pt"
